// Because of github rate limit I didn't finish it
// Dunno if that works as expected, should be checked

// TODO: Try class decorators
...
const listCommitsMessagesFor = stopwatch(async url => {
  ...
  const commits = await Promise.all(
    commitsUrls.map(async url => throttle(() => fetchit(url)))
  );
  return commits;
});
